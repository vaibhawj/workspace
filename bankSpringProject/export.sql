...
--------------------------------------------------------
  ...
  CREATE TABLE "VKU"."CUSTOMER_ACCOUNT" 
   (	"CUST_ID" NUMBER, 
	"ACC_ID" NUMBER
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "VKU"."ACC_SEQ"  MINVALUE 1 MAXVALUE 999999 INCREMENT BY 1 START WITH 6 NOCACHE  ORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence CUST_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "VKU"."CUST_SEQ"  MINVALUE 1 MAXVALUE 999999 INCREMENT BY 1 START WITH 3 NOCACHE  ORDER  NOCYCLE ;
REM INSERTING into VKU.ACCOUNT
SET DEFINE OFF;
Insert into VKU.ACCOUNT (ACC_ID,BALANCE) values (4,356.47);
Insert into VKU.ACCOUNT (ACC_ID,BALANCE) values (5,256.47);
Insert into VKU.ACCOUNT (ACC_ID,BALANCE) values (1,567.47);
Insert into VKU.ACCOUNT (ACC_ID,BALANCE) values (2,756.47);
Insert into VKU.ACCOUNT (ACC_ID,BALANCE) values (3,167.47);
...
Insert into VKU.CUSTOMER (CUST_ID,CUST_NAME) values (2,'Karry');
REM INSERTING into VKU.CUSTOMER_ACCOUNT
SET DEFINE OFF;
Insert into VKU.CUSTOMER_ACCOUNT (CUST_ID,ACC_ID) values (2,4);
Insert into VKU.CUSTOMER_ACCOUNT (CUST_ID,ACC_ID) values (2,5);
Insert into VKU.CUSTOMER_ACCOUNT (CUST_ID,ACC_ID) values (1,1);
Insert into VKU.CUSTOMER_ACCOUNT (CUST_ID,ACC_ID) values (1,2);
Insert into VKU.CUSTOMER_ACCOUNT (CUST_ID,ACC_ID) values (2,3);
